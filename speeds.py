...
# 4G
speeds_4G = {"att": 7.2, "t_mobile": 14.8, "verizon": 7.8}

# 5G
speeds_5G = {"att": 15.8, "t_mobile": 18.7, "verizon": 20.3}

# 5G availability in Texas
availability_5G = {"att": 16.7, "t_mobile": 69.4, "verizon": 8.2}
...
def select_speed(seed=None):
    ...
    is_5G = np.random.choice(
        [True, False],
        p=[availability_5G[provider] / 100, 1 - availability_5G[provider] / 100],
    )
