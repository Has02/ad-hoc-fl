        ...
        for mtype in mtype_lst:
            for seed in [42, 182, 392]:
                create_mobility_data(
                    ...
                    mtype=mtype,
                    seed=seed,
                    non_mobility=non_mobility,
                )


def main():
    create_data(devices=100, aps_lst=[100], mtype_lst=["hierfavg"], non_mobility=True)
    create_data(devices=100, aps_lst=[100], mtype_lst=["hierfavg"], non_mobility=False)
